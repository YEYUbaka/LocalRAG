...
| P1-01 Golden Set v1 | RAG + 全员 | 🔄 机器草稿待人工复核 | 本分支已起草 56 条、覆盖 17 篇 interview Markdown 与四类非 OCR 题型；尚未生成正式 v1 |
| P1-02 评测 CLI | RAG | 🔄 实现完成，PR 待评审 | `feat/P1-02-eval-toolchain`；临时 fixture 两次运行 summary 逐字节一致，真实 21 文档基线尚未执行 |
